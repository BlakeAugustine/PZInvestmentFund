...
mypacks <- c("ggplot2","dplyr", "quantmod", "tidyverse", "finreportr", "simfinR")  # what packages are needed?
...
```{r}
WC_ratio <- 184110000000 / 61782000000
WC_ratio
```
...
```{r}
quick_ratio <- (184110000000 - 1278000000) / 61782000000
quick_ratio
```
...
```{r}
DE_ratio <- 102836000000 / 244567000000
DE_ratio
```
